...
} from "../../Redux/moreInformationApis";
...
const MoreInformation = () => {
  ...
  const [updateMoreInformation, { isLoading: isSaving }] =
    useCreateMoreInformationMutation();

  useEffect(() => {
    if (moreInformation?.content) {
      setContent(moreInformation.content);
      setOriginalContent(moreInformation.content);
    }
  }, [moreInformation]);
